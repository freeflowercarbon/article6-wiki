...
=== "🇬🇧 English"
    ...
    ## Acquiring Countries (Demand Side) — 6 Countries

    Countries that acquire ITMOs to meet NDC targets or domestic carbon obligations.
    ...
    ## Host Countries (Supply Side) — 29 Countries

    Countries generating and transferring ITMOs. Coverage focuses on Japan JCM and Singapore IA partner countries.

    ### Southeast Asia

    | Country | JCM/IA | NBS Maturity | Key Recent Development |
    |---------|--------|-------------|----------------------|
    ...
    | Country | JCM/IA | NBS Maturity | Key Recent Development |
    |---------|--------|-------------|----------------------|
    | [🇵🇬 Papua New Guinea](countries/papua_new_guinea.md) | Japan JCM ✅ / SG IA ✅ | ⭐⭐⭐⭐ | World's 3rd largest tropical forest; governance strengthening |
    | [🇲🇳 Mongolia](countries/mongolia.md) | Japan JCM ✅ / SG IA ✅ (2025) | ⭐⭐ | Grassland & forest carbon; multiple energy efficiency JCM projects |
    | [🇺🇿 Uzbekistan](countries/uzbekistan.md) | Japan JCM ✅ | ⭐⭐ | Aral Sea restoration NBS under study |
    | [🇰🇿 Kazakhstan](countries/kazakhstan.md) | Japan JCM ✅ | ⭐⭐ | CIS's first operating ETS |
    | [🇬🇪 Georgia](countries/georgia.md) | Japan JCM ✅ / Switzerland ✅ | ⭐⭐ | Forest, hydro, Switzerland bilateral |
    | [🇵🇼 Palau](countries/palau.md) | Japan JCM ✅ | ⭐ | Ocean protection, blue carbon |
    | [🇲🇻 Maldives](countries/maldives.md) | Japan JCM ✅ | ⭐ | Small island state; adaptation priority |

    ### Latin America

    | Country | JCM/IA | NBS Maturity | Key Recent Development |
    |---------|--------|-------------|----------------------|
    | [🇵🇪 Peru](countries/peru.md) | Switzerland ✅ / SG IA ✅ | ⭐⭐⭐⭐⭐ | World's 1st A6.2 ITMO transfer (Switzerland 2023) |
    | [🇵🇾 Paraguay](countries/paraguay.md) | SG IA ✅ | ⭐⭐ | Gran Chaco forest; SG RFP1 contract awarded |
    | [🇨🇱 Chile](countries/chile.md) | Japan JCM ✅ / SG IA ✅ / CH ✅ | ⭐⭐⭐ | Temperate forest, blue carbon, carbon tax |
    | [🇨🇴 Colombia](countries/colombia.md) | Japan JCM ✅ / SG MOU | ⭐⭐⭐⭐ | Amazon & Andes REDD+ abundance |
    | [🇲🇽 Mexico](countries/mexico.md) | Japan JCM ✅ | ⭐⭐ | Domestic ETS pilot; partial REDD+ progress |
    | [🇨🇷 Costa Rica](countries/costa_rica.md) | Japan JCM ✅ / SG MOU | ⭐⭐⭐⭐ | REDD+ pioneer; advanced decarbonization |

    ### Africa

    | Country | JCM/IA | NBS Maturity | Key Recent Development |
    |---------|--------|-------------|----------------------|
    | [🇬🇭 Ghana](countries/ghana.md) | SG IA ✅ / Switzerland ✅ / Sweden ✅ | ⭐⭐⭐⭐ | A6.2 live transactions; SG RFP1 ×2 contracts |
    | [🇷🇼 Rwanda](countries/rwanda.md) | SG IA ✅ / Sweden ✅ | ⭐⭐⭐ | National Carbon Market Policy 2024 |
    | [🇰🇪 Kenya](countries/kenya.md) | Japan JCM ✅ / Sweden ✅ | ⭐⭐⭐ | Government Carbon Trading Policy 2023 |
    | [🇸🇳 Senegal](countries/senegal.md) | Japan JCM ✅ / Switzerland ✅ | ⭐⭐ | Mangrove, Great Green Wall |
    | [🇪🇹 Ethiopia](countries/ethiopia.md) | Japan JCM ✅ | ⭐⭐ | REDD+ in development; political risk |
    | [🇨🇮 Côte d'Ivoire](countries/cote_divoire.md) | Japan JCM ✅ | ⭐⭐ | Cocoa agroforestry, tropical forest JCM |
    | [🇲🇦 Morocco](countries/morocco.md) | Switzerland negotiating | ⭐⭐ | Switzerland bilateral under negotiation |

    ### Other JCM Partners

    | Country | JCM | Key Recent Development |
    |---------|-----|----------------------|
    | [🇧🇩 Bangladesh](countries/bangladesh.md) | Japan JCM ✅ | Mangrove, energy efficiency, climate adaptation priority |
    | [🇹🇳 Tunisia](countries/tunisia.md) | Japan JCM ✅ / Switzerland ✅ | Solar, wind JCM; Switzerland bilateral |
    | [🇲🇩 Moldova](countries/moldova.md) | Japan JCM ✅ | EU accession track; activity declining |
    | [🇦🇿 Azerbaijan](countries/azerbaijan.md) | Japan JCM ✅ | COP29 host (2024); post-COP29 framework |

    ---

    ## Concepts

    - [ITMO (Internationally Transferred Mitigation Outcome)](concepts/itmo.md)
    - [Corresponding Adjustment](concepts/corresponding_adjustment.md)
    - [JCM (Joint Crediting Mechanism)](concepts/jcm.md)
...
=== "🇯🇵 日本語"
    ...
    ITMOを生成・移転する国。日本JCMまたはシンガポールIAのパートナー国を中心に収録。
    ...
    | 国 | JCM/IA | NBS成熟度 | 主な最新動向 |
    |---|---|---|---|
    | [🇵🇬 パプアニューギニア](countries/papua_new_guinea.md) | 日本JCM ✅ / SG IA ✅ | ⭐⭐⭐⭐ | 世界3位の熱帯雨林・ガバナンス強化中 |
    ...
    | [🇲🇽 メキシコ](countries/mexico.md) | 日本JCM ✅ | ⭐⭐ | 国内ETS試験中・REDD+一部進行 |
    | [🇨🇷 コスタリカ](countries/costa_rica.md) | 日本JCM ✅ / SG MOU | ⭐⭐⭐⭐ | REDD+先進・脱炭素先進国 |

    ### アフリカ

    | 国 | JCM/IA | NBS成熟度 | 主な最新動向 |
    |---|---|---|---|
    | [🇬🇭 ガーナ](countries/ghana.md) | SG IA ✅ / スイス ✅ / スウェーデン ✅ | ⭐⭐⭐⭐ | A6.2実取引実績・SG RFP第1回 ×2 |
    | [🇷🇼 ルワンダ](countries/rwanda.md) | SG IA ✅ / スウェーデン ✅ | ⭐⭐⭐ | 国家炭素市場ポリシー2024 |
    | [🇰🇪 ケニア](countries/kenya.md) | 日本JCM ✅ / スウェーデン ✅ | ⭐⭐⭐ | 政府炭素取引ポリシー2023 |
    | [🇸🇳 セネガル](countries/senegal.md) | 日本JCM ✅ / スイス ✅ | ⭐⭐ | マングローブ・グレートグリーンウォール |
    | [🇪🇹 エチオピア](countries/ethiopia.md) | 日本JCM ✅ | ⭐⭐ | REDD+整備中・政情注意 |
    | [🇨🇮 コートジボワール](countries/cote_divoire.md) | 日本JCM ✅ | ⭐⭐ | カカオ農地・熱帯林JCM検討 |
    | [🇲🇦 モロッコ](countries/morocco.md) | スイス交渉中 | ⭐⭐ | スイスとのバイラテラル交渉中 |

    ### その他JCMパートナー

    | 国 | JCM | 主な最新動向 |
    |---|---|---|
    | [🇧🇩 バングラデシュ](countries/bangladesh.md) | 日本JCM ✅ | マングローブ・省エネ・気候適応優先 |
    | [🇹🇳 チュニジア](countries/tunisia.md) | 日本JCM ✅ / スイス ✅ | 太陽光・風力JCM・スイス協定 |
    | [🇲🇩 モルドバ](countries/moldova.md) | 日本JCM ✅ | EU接近・活動縮小傾向 |
    | [🇦🇿 アゼルバイジャン](countries/azerbaijan.md) | 日本JCM ✅ | COP29開催国（2024）・ポストCOP29整備 |

    ---

    ## 概念解説

    - [ITMO（国際移転緩和成果）](concepts/itmo.md)
    - [Corresponding Adjustment（対応調整）](concepts/corresponding_adjustment.md)
    - [JCM（二国間クレジット制度）](concepts/jcm.md)
