# Georgia 🇬🇪 | ジョージア — Article 6.2 Host Country
...
=== "🇬🇧 English"
    ...
    | Metric | Assessment |
    |--------|-----------|
    | Unconditional target (35%) | 🟡 Hydropower transition supporting; non-energy sectors challenging |
    | Conditional target (50%) | 🟡 Requires international finance |
    | Key driver | Hydropower; RE expansion; EU alignment |
    | EU accession implication | Carbon market alignment with EU ETS creates pathway for higher ambition |
    ...
    |-------------|---------|--------|-------|
    | Landfill gas to energy | Switzerland | 🟡 Active | FOEN-reviewed |
    | Hydropower (small) | Japan / Switzerland | 🟡 Active | Multiple projects |
    | Forest conservation | Switzerland | 🟡 In development | NBS pipeline |

    ## NBS Resources

    | Category | Maturity | Notes |
    |----------|----------|-------|
    | Forest (broadleaf, mixed — Caucasus) | ⭐⭐⭐ | High biodiversity; fire risk |
    | Agricultural soil (viticulture) | ⭐⭐ | Wine-producing regions; organic farming |
    | Wetlands, rivers | ⭐⭐ | — |
    ...
    ## Key Sources
    - Georgia NDC: <https://unfccc.int/NDCREG>
    ...
    - JCM Georgia: <https://gec.jp/jcm/projects/>
