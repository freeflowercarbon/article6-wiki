# Indonesia 🇮🇩 | インドネシア — Article 6.2 Host Country
...
=== "🇬🇧 English"
    ...
    Formal A6.2 authorization under SRN (national registry) began post-Perpres 110/2025:

    | Project Type | Partner | Status | Est. Volume |
    |-------------|---------|--------|-------------|
    | JCM energy efficiency (industry) | Japan | 🟡 Perpres path open | ~1–5 Mt/yr potential |
    | JCM renewable energy (geothermal, solar) | Japan | 🟡 Processing | ~2–10 Mt/yr potential |
    | REDD+ (Kalimantan, Sumatra) | Japan, prospective SG | 🟡 Authorization pending | Large (100+ Mt potential) |
    | Peatland restoration | Prospective SG IA | 🔄 Dependency on IA | Large |
    ...
    **CCP status note**: ICVCM approved the Verra VCS *program* at program level (2024), but specific REDD+ methodologies (VM0007, VM0009) have NOT yet received the CCP label due to concerns about permanence, additionality, and leakage. ART TREES has received CCP approval for jurisdictional REDD+.[^artccp] Approval of project-level REDD+ methodologies expected 2026–2027.
    ...
    - Perpres 110/2025: <https://peraturan.bpk.go.id/>
    - IDXCarbon: <https://idxcarbon.co.id/>
    - KLHK: <https://www.menlhk.go.id/>
    - JCM Indonesia: <https://gec.jp/jcm/projects/>
...
=== "🇯🇵 日本語"
    ...
    Perpres 110/2025後にSRUK（新取引登録簿）でのA6.2授権が開始：

    | 種別 | 相手国 | 状況 |
    |------|--------|------|
    | JCM省エネ（工業） | 日本 | 🟡 処理開始 |
    | JCM再エネ（地熱・太陽光） | 日本 | 🟡 処理中 |
    | REDD+（カリマンタン・スマトラ） | 日本・SG見込み | 🟡 授権待ち |
