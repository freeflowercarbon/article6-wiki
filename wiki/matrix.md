# Bilateral Matrix — Host Country × Acquiring Country
# 二国間マトリクス — ホスト国 × 調達国

=== "🇬🇧 English"

    > Last updated: **2026-08-02** | **A6.4 Supervisory Body 22nd meeting (Bonn, Jul 27–30, 2026) concluded**: approved a grid-connected renewable electricity methodology (3rd A6.4-native methodology, after landfill gas and N2O abatement) and deferred a cookstove methodology decision pending non-permanence/uncertainty work（要確認, secondary-source corroboration only）— see [PACM](concepts/pacm.md) | **Japan-Palau first JCM ITMO transfer (Jun 2, 2026, 194 tCO₂e, PW001–004) backfilled into the tracker** — previously missing; Pacific SIDS' first-ever JCM transfer, Japan's 3rd JCM transfer (before Mongolia) — see [itmo_tracker.md](itmo_tracker.md) | **MOEJ official position on JCM "year-limit problem" (Jul 3, 2026 webinar): 2030-NDC cancellation deadline = before BTR5 (Dec 31, 2032); vintage basis confirmed; GX-ETS 2031+ rules undecided; JCM credit trading market to be established** — see [JCM 2030 Problem](concepts/jcm_2030_problem.md) | Japan-Mongolia first JCM ITMO transfer (Jul 6, 2026, 86,564 tCO₂e, 4 projects), Mongolia's first-ever JCM transfer — see [itmo_tracker.md](itmo_tracker.md) | PACM/CDM transition: Jun 30, 2026 host-country-approval deadline passed — only 415 of 1,512 CDM activities (27%, ~617M t) secured approval to transition; China blocked 527 projects (~251M t), India approved 0 of 460 (~182M t); new PDD deadline Dec 31, 2026, non-transitioned CDM credits face cancellation Jul 1, 2027 | Rwanda cookstove credits (5M+, DelAgua-linked) reportedly CA-recorded and cleared for Article 6/CORSIA trade, late Jul 2026（要確認, paywalled headline only, not a confirmed ITMO transfer）— see [CORSIA](buyers/corsia.md) | Quiet week otherwise — no new confirmed bilateral agreements or ITMO transfers found across Groups A–C (acquirers, SE Asia/Pacific, Africa/LatAm/Central Asia) since the 2026-07-26 crawl
    ...
    ## Acquiring Country Carbon Prices & Mechanisms
    ...
    | **Detail page** | [→](countries/japan.md) | [→](countries/singapore.md) | [→](countries/switzerland.md) | [→](countries/sweden.md) | [→](countries/norway.md) | [→](countries/korea.md) |

    [^jpgx]: Japan GX-ETS price floor/ceiling (FY2026): Carbon Pulse <https://carbon-pulse.com/469821/>; ICAP <https://icapcarbonaction.com/en/ets/japan-gx-ets>
    [^sgprice]: Singapore carbon tax schedule: NEA <https://www.nea.gov.sg/our-services/climate-change-energy-efficiency/carbon-tax>
    [^chprice]: Switzerland CO₂ levy and NDC obligation: FOEN <https://www.bafu.admin.ch/bafu/en/home/topics/climate/info-specialists/climate-and-international-cooperation/bilateral-agreements-on-the-implementation-of-article-6-of-the.html>
    [^seprice]: Sweden carbon tax: Energimyndigheten <https://www.energimyndigheten.se/en/cooperation/swedens-program-for-international-climate-initiatives/paris-agreement/>
    [^noprice]: Norway CO₂ tax: Ministry of Climate and Environment <https://www.regjeringen.no/en/dep/kld/id668/>
    [^krprice]: Korea K-ETS price data: ICAP <https://icapcarbonaction.com/en/ets/korea-emissions-trading-scheme>
    [^jcmm]: JCM methodology guidelines: <https://www.meti.go.jp/policy/energy_environment/global_warming/jcm/pdf/en_Guidelines_for_the_Implementation_of_JCM.pdf>
    ...
    | [Palau 🇵🇼](countries/palau.md) | 🟢 JCM(2014) **ITMO Jun 2026** | — | — | — | — | — |
    ...
    | Cambodia 🇰🇭 | ⭐⭐⭐ | ⭐⭐⭐ | ⭐⭐ | JCM + SG dual; first JCM NBS credit (Prey Lang) |
    | Chile 🇨🇱 | ⭐⭐⭐⭐ | ⭐⭐⭐ | ⭐⭐ | JCM + SG + CH triple access |
    | Vietnam 🇻🇳 | ⭐⭐⭐ | ⭐⭐ | ⭐⭐ | JCM volume + new SG IA 2025 |
    | Colombia 🇨🇴 | ⭐⭐⭐⭐ | ⭐⭐ | ⭐⭐ | Amazon + Andes + carbon tax track record |

=== "🇯🇵 日本語"

    > 最終更新: **2026-08-02** | **A6.4監督機関第22回会合（ボン、2026年7月27〜30日）が終了**：系統連系型再エネ発電の方法論を承認（埋立地ガス・N2O削減に次ぐ3件目のA6.4固有方法論）、かまど方法論の決定は非永続性・不確実性の追加検討のため見送り（要確認、二次情報源による裏付けのみ）— [PACM](concepts/pacm.md)参照 | **日本-パラオ初のJCM ITMO移転（2026年6月2日、194 tCO₂e、PW001〜004）をトラッカーに補完** — 従来記載漏れ；太平洋SIDS初のJCM移転、日本にとって3件目のJCM移転（モンゴルより前）— [itmo_tracker.md](itmo_tracker.md)参照 | **環境省がJCM「年限問題」に公式見解（2026年7月3日ウェビナー）：2030年NDC計上の無効化期限＝BTR5前（2032年12月31日）；ビンテージ基準確認；GX-ETS 2031年以降ルール未定；JCMクレジット取引市場を早期整備** — [JCM 2030年問題](concepts/jcm_2030_problem.md)参照 | 日本-モンゴル初のJCM ITMO移転（2026年7月6日、4プロジェクト合計86,564 tCO₂e）、モンゴル史上初のJCM移転 — [itmo_tracker.md](itmo_tracker.md)参照 | PACM/CDM移行：2026年6月30日のホスト国承認期限が到来 — CDM1,512件中415件（27%、約6.17億t）のみ移行承認取得；中国は527件（約2.51億t）を承認拒否、インドは460件中0件承認；新PDD提出期限2026年12月31日、未移行CDMクレジットは2027年7月1日に失効 | ルワンダのかまどクレジット（500万t超、DelAgua関連）がCA記録済みとなりArticle 6・CORSIA取引が可能に、2026年7月下旬（要確認、有料記事見出しのみ、ITMO移転確定ではない）— [CORSIA](buyers/corsia.md)参照 | 全体として静かな週 — GループA〜C（調達国、東南アジア・太平洋、アフリカ・中南米・中央アジア）で2026-07-26クロール以降の新規二国間協定・ITMO移転の確認なし
    > **ホスト国**: ITMOを生成・移転する国（プロジェクト実施側）
    > **調達国**: ITMOを取得してNDC達成・国内炭素義務に充当する国

    ## 調達国の炭素価格・制度概要

    | | 日本 🇯🇵 | シンガポール 🇸🇬 | スイス 🇨🇭 | スウェーデン 🇸🇪 | ノルウェー 🇳🇴 | 韓国 🇰🇷 |
    |---|---|---|---|---|---|---|
    ...
    | **詳細ページ** | [→](countries/japan.md) | [→](countries/singapore.md) | [→](countries/switzerland.md) | [→](countries/sweden.md) | [→](countries/norway.md) | [→](countries/korea.md) |
    ...
    | [パラオ 🇵🇼](countries/palau.md) | 🟢 JCM(2014) **ITMO 2026年6月** | — | — | — | — | — |
    ...
    | チリ 🇨🇱 | ⭐⭐⭐⭐ | ⭐⭐⭐ | ⭐⭐ | JCM+SG+CHトリプルアクセス |
    | ベトナム 🇻🇳 | ⭐⭐⭐ | ⭐⭐ | ⭐⭐ | JCM実績多数＋新SG IA 2025 |
